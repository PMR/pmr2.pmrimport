...
URIS = [
    ...
    'http://www.cellml.org/models/komarova_wodarz_2003_version01',
]
...
class BaseCellMLBuilderTestCase(unittest.TestCase):
    ...
    def test_download_cellml_unmangle_rdf(self):
        uri = URIS[20]  # komarova_wodarz_2003_version01
        self.builder.uri = uri
        self.builder.prepare_path()
        self.builder.download_cellml()
        f = open(self.builder.cellml_filename).read()
        self.assert_('http://www.w3.org/1999/0P/PP-rdf-sSntaS-ns#"' not in f)
